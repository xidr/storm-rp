...
public partial class CameraRenderer {
    ...
    // Additions
    //
    StencillPrepass _stencilPrepass = new StencillPrepass();
    ...
    public void Render(
        ...
        RAPI.bufferSize = bufferSize;
        RAPI.CullingResults = cullingResults;
        RAPI.useDynamicBatching = useDynamicBatching;
        RAPI.useGPUInstancing = useGPUInstancing;
        RAPI.Buffer = buffer;
